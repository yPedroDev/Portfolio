            ...
            <div>
              ...
              <p style={{ color: "black" }} className="py-6">
                <a>
                  ...
                  <span className="text-orange-500">pedro albino barbosa</span>
                  ,
                  <div className="m-1" />
                  <span>
                  ...
                  <span>
                    {" "}
                    Estudo em <b style={{ color: "pink" }}>programação</b>{" "}
              ...
              <div className={isMobile ? "flex-col lg:flex-row justify-center" : "flex flex-wrap justify-center"}>
